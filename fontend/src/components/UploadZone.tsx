...
export default function UploadZone({ label, file, onClear, onChange }: UploadZoneProps) {
  return (
    <div className="relative group">
      ...
      `}>
        {file ? (
          <>
            <img src={URL.createObjectURL(file)} alt="Uploaded file preview" className="obsolute inset-0 w-full h-full object-cover rounder-xl opacity-60" />
            <div>
            ...
            <div className="absolute bottom-4 left-4 right-4 bg-black/50 backdrop-blur-md p-3 rounded-1g border border-white/10">
